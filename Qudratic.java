...
{ int a,b,c; 
double root1,root2;//coefficients double root1,root2; 
System.out.println("enter the coefficients");
 Scanner in=new Scanner(System.in); 
a=in.nextInt();
 b=in.nextInt(); 
 c=in.nextInt(); // calculate the dis(b2-4ac)
  double d=(b*b)-(4*a*c); 
System.out.println("Determinant="+d); //check if discriminant is greater than 0 
if (d>0) 
{ 
...
//check if discriminant less than 0 else 
{ 
